      ...
      <div className="flex flex-col">
        <div className="flex sm:justify-between content-center flex-col">
          ...
          <div className="p-6 flex flex-col md:flex-row">
            <div className="flex self-center flex-col grow w-full">
              <span className="text-2xl font-semibold">Blogs</span>
              <span style={{fontSize: '12px'}} className="text-gray-600 ">Home / Blogs</span>
            </div>
          ...
          <div className="flex flex-col md:pl-6 md:mt-3">
            <div className="flex flex-col md:flex-row ">
              ...
              <Button className="bg-blue-900 text-white md:mr-6" >
                Add Blogs
              </Button>
